         ...
         "items": [
            ...
            P("Razer Viper V3 Pro",
              ...
              [("重量", "約54g（±1g）"), ("サイズ", "125 × 63.5 × 40mm（左右対称）"),
               ...
               ("バッテリー", "最大95時間")],
              "現行トップ級の軽さに8,000Hzポーリングを組み合わせた競技特化。"
         ...
         "items": [
            P("Razer DeathAdder V3 Pro",
              ...
              [("重量", "約63g"), ("サイズ", "128 × 68 × 44mm（右手用エルゴ）"),
               ...
               ("バッテリー", "最大90時間")],
              "名作エルゴの最軽量級。先代88gから約30%軽量化しつつ握り心地は随一で、"
        ...
        {"kicker": "RAPID TRIGGER FLAGSHIP", "h2": "① ラピッドトリガーの本命（磁気軸）",
         ...
         "items": [
            ...
            P("SteelSeries Apex Pro TKL Gen 3",
              ...
              "調整幅・機能・耐久のバランスが最良クラス。OLEDで設定確認ができ、"
        ...
        {"kicker": "FLAGSHIP", "h2": "③ 最上位オールラウンド",
         ...
         "items": [
            P("SteelSeries Arctis Nova Pro Wireless",
              ...
              "ベースステーションやANCも含め、一台で全部こなしたい人の決定版。"),
         ]},
...
{sense_rows}
    ...
    <footer class="site-footer">
      ...
      <nav aria-label="運営情報">
        <a href="gaming-monitor-guide.html"><span data-icon="monitor"></span>モニター</a>
